...
from app.services.whatsapp_inbound_processor import process_inbound_whatsapp_message
...
async def receive_webhook(
    ...
    inbound_repository: Annotated[
        WhatsappInboundRepository, Depends(get_whatsapp_inbound_repository)
    ],
    ...
    if not settings.webhook_agent_enabled:
        ...
        return {"status": "ok", "enqueued": 0, "agent_enabled": False}
