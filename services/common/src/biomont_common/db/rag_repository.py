"""Repositorio para retrieval hibrido sobre `knowledge_chunks`.
...
def _metadata_row_to_dict(value: Any) -> dict:
    """Normaliza metadata jsonb traído por asyncpg."""
...
class RagRepository:
    """Encapsula consultas hibridas y persistencia de knowledge chunks."""
